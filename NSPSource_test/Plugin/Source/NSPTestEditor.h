...
#ifndef NSPTESTEDITOR_H_INCLUDED
#define NSPTESTEDITOR_H_INCLUDED
...
class NSPTestEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders.
...
public:
	...
	NSPTestEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);
...
private:
	...
	*/
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(NSPTestEditor);
};
