...
#include "NSPTestEditor.h"
#include "NSPTest.h"

NSPTestEditor::NSPTestEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
*/
void NSPTestEditor::buttonEvent(Button* button)
{
